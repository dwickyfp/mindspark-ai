...
export type McpServerAccess = McpServerSelect & {
...
export interface MCPRepository {
  ...
  selectAccessibleForUser(userId: string): Promise<McpServerAccess[]>;
  deleteById(id: string): Promise<void>;
  existsByServerName(name: string): Promise<boolean>;
  selectByIds(ids: string[]): Promise<McpServerSelect[]>;
}
